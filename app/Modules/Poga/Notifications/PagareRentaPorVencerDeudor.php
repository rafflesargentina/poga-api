...
class PagareRentaPorVencerDeudor extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
	$pagare = $this->pagare;
        $content = normalize('Tenes un pago pendiente de renta que vence el '.Carbon::parse($pagare->fecha_vencimiento)->format('d/m/Y').', realiza tu pago en: '.str_replace('api.', 'app.', url('realiza-un-pago/'.$pagare->id)));

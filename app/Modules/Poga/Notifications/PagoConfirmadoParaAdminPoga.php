...
class PagoConfirmadoParaAdminPoga extends Notification implements ShouldQueue
{
    use Queueable;
	...
	$line2 = 'Propietario: '.$acreedor->nombre_y_apellidos;
        ...
        $line4 = 'Se le notificará al momento de la transferencia a su cuenta bancaria.';
	    ...
	    ->markdown('poga::mail.pago-confirmado-para-admin-poga', ['boleta' => $this->boleta, 'pagare' => $pagare, 'user' => $notifiable]);
    }

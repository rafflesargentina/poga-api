...
class InmuebleActualizado extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Actualizaste un Inmueble de nuestros registros')
            ->greeting('Hola '.$this->user->idPersona->nombre)
            ->line('Actualizaste el inmueble nombrado "'.$this->inmueble->idInmueblePadre->nombre.'"')

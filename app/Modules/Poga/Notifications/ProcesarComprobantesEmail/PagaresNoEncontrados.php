...
class PagaresNoEncontrados extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $line1 = 'No se encontraron pagares activos con los datos del comprobante procesado:';
        ...
        return (new MailMessage)
            ->subject('Procesar Comprobantes via Email: Pagares no encontrados')

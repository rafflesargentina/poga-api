...
class PagoConfirmadoDeudor extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
	    ...
	    ->action('Ir a "Mis Pagos"', str_replace('api.', 'app.', url('/cuenta/mis-pagos')))
            ->markdown('poga::mail.pago-confirmado-para-deudor', ['boleta' => $this->boleta, 'pagare' => $pagare, 'user' => $notifiable]);
    }

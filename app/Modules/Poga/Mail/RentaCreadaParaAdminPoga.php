...
class RentaCreadaParaAdminPoga extends Mailable
{
    ...
    {
        return $this->markdown('poga::mail.renta-creada-para-admin-poga', ['renta' => $this->renta, 'user' => $this->user, 'boleta' => $this->boleta]);
    }
}

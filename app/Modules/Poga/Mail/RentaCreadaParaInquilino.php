...
class RentaCreadaParaInquilino extends Mailable
{
    ...
    {
        return $this->markdown('poga::mail.renta-creada-para-inquilino', ['renta' => $this->renta, 'user' => $this->user, 'boleta' => $this->boleta]);
    }
}

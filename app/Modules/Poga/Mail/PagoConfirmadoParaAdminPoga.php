...
class PagoConfirmadoParaAdminPoga extends Mailable
{
    ...
    {
        return $this->markdown('poga::mail.pago-confirmado-para-admin-poga', ['pagare' => $this->pagare, 'user' => $this->user, 'boleta' => $this->boleta]);
    }
}

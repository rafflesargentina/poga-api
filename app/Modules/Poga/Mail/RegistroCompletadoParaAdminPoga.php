...
class RegistroCompletadoParaAdminPoga extends Mailable
{
	...
	$paises = Pais::get()->pluck('nombre', 'id')->toArray();
        ...
        return $this->markdown('poga::mail.registro-completado-para-admin-poga', ['user' => $this->user, 'bancos' => $bancos, 'paises' => $paises, 'roles' => $roles]);
    }
}

...
class PagoConfirmadoAcreedor extends Mailable
{
    ...
    {
        return $this->markdown('poga::mail.pago-confirmado-para-acreedor', ['pagare' => $this->pagare, 'user' => $this->user, 'boleta' => $this->boleta]);
    }
}
